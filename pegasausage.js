...
// TODO: Replace these with some other audio solution
...
// init branding
var tpLogoImg = new THREE.TextureLoader().load("deltaryzlogo.png");
...
var creditsText =
  ...
  "<br/>Background: <a href='http://goblinengineer.deviantart.com/'>GoblinEngineer</a>" +
  "<br/>Music: <a href='https://deltaryz.bandcamp.com/track/bestest-friends'>ƥRYZ & Layl - Bestest Friends</a>";

var crosshair = document.createElement("div");
crosshair.style.position = "absolute";
crosshair.innerHTML = "<img src='crosshair.png' height='20' width='20'>";
crosshair.style.top =
  window.innerHeight / 2 - crosshair.offsetHeight / 2 + "px";
...
function generateSprites() {
  for (i = 0; i < cloudAmount; i++) {
    ...
    mesh.position.set(
      Player.position.x + getRandomArbitrary(-7.5, 7.5),
      Player.position.y + getRandomArbitrary(-7.5, 7.5),
  ...
  if (hp < difficulty.hp) {
    if (getRandomInt(0, 20) == 13) {
      ...
      var sausageMaterial = new THREE.MeshBasicMaterial({
        map: sausageTexture,
        transparent: true,
      });
      var sausageMesh = new THREE.Mesh(cloudplaneGeometry, sausageMaterial);
      sausageMesh.position.set(
        Player.position.x + getRandomArbitrary(-2, 2),
        Player.position.y + getRandomArbitrary(-2, 2),
        getRandomArbitrary(-20, -25)
      );
...
enableSound.style.left =
  window.innerWidth / 2 - enableSound.offsetWidth / 2 + "px";
...
function render() {
  ...
  if (gameState == 1) {
    ...
    crosshair.style.left =
      window.innerWidth / 2 - crosshair.offsetWidth / 2 + "px";
    ...
    if (mousedown && touchInput == true) {
      if (
        mousex > window.innerWidth / 2 - window.innerWidth / 4 &&
        mousex < window.innerWidth / 2 + window.innerWidth / 4 &&
      ...
      if (
        (mousex < window.innerWidth / 2 - window.innerWidth / 4 &&
          mousey < window.innerHeight / 2 - window.innerHeight / 4) ||
        (mousex > window.innerWidth / 2 + window.innerWidth / 4 &&
          mousey < window.innerHeight / 2 - window.innerHeight / 4)
      ) {
        Player.position.y += playerSpeed;
    ...
    text2.innerHTML =
      "This is one of the first games I created,<br/>originally published in 2015." +
      "<br/><br/>Difficulty: " +
      difficulty.name;
    text2.style.top =
      window.innerHeight / 2 -
